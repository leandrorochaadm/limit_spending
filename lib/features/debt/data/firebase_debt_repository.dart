...
class FirebaseDebtRepository implements DebtRepository {
  ...
  Future<PaginatedResult<DebtEntity>> getDebtsPaginated({
    ...
    try {
      ...
      final exception = AppExceptionUtils.handleFirebaseError(e);
      LoggerService.error('getDebtsPaginated', exception.message);
      throw exception;
    } catch (e, s) {
      LoggerService.error('getDebtsPaginated', e, s);
      rethrow;
    }
  }
}
